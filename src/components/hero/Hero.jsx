...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ height: '100vh', minHeight: 700, background: '#010409' }}>
      ...
      <MetricCard icon="🚨" label="Active Alerts"   value="3 Critical"  sub="Needs triage"   color="#FF4444" delay={2.0} x="2%"  y="18%" />
      <MetricCard icon="🛡️" label="Shield Status"   value="ACTIVE"      sub="All systems UP"  color="#00F5FF" delay={2.2} x="2%"  y="46%" />
      <MetricCard icon="⚡" label="Alerts Triaged"  value="244 / 247"   sub="Today's queue"   color="#FFD700" delay={2.4} x="2%" y="68%" />
